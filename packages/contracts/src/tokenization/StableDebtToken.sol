...
contract StableDebtToken is IStableDebtToken, DebtTokenBase {
        ...
        returns (bool, uint256, uint256)
    {
        ...
        // TODO see how to set the total supply and cross chain supply
    ...
    function burn(address user, uint256 amount) external override onlyLendingPool returns (uint256, uint256) {
        ...
        if (previousSupply <= amount) {
            ...
            if (secondTerm >= firstTerm) {
                ...
                newAvgStableRate = _avgStableRate = (firstTerm - secondTerm) / nextSupply.wadToRay();
            }
        }
        ...
        if (balanceIncrease > amount) {
            ...
            emit Mint(
                user, user, amountToMint, currentBalance, balanceIncrease, userStableRate, newAvgStableRate, nextSupply
            );
        } else {
        ...
        return balanceIncrease > amount ? (1, amountToMint) : (2, amountToBurn);
    }
